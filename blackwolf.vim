" A very slight modification of Steve Losh's
" Bad Wolf colorscheme to have a black background.
"
" Bad Wolf: http://stevelosh.com/projects/badwolf/
...
if !exists("g:blackwolf_html_link_underline") " {{{
    let g:blackwolf_html_link_underline = 1
endif " }}}

if !exists("g:blackwolf_css_props_highlight") " {{{
    let g:blackwolf_css_props_highlight = 0
endif " }}}
...
if exists('g:blackwolf_darkgutter') && g:blackwolf_darkgutter
    let s:gutter = 'blackestgravel'
else
    let s:gutter = 'blackgravel'
endif

if exists('g:blackwolf_tabline')
    if g:blackwolf_tabline == 0
        let s:tabline = 'blackestgravel'
    elseif  g:blackwolf_tabline == 1
        let s:tabline = 'blackgravel'
    elseif  g:blackwolf_tabline == 2
        let s:tabline = 'darkgravel'
    elseif  g:blackwolf_tabline == 3
...
if g:blackwolf_css_props_highlight
...
if g:blackwolf_html_link_underline
